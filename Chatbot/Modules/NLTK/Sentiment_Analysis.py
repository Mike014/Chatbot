...
class Classifier(SklearnClassifiers):
    ...
    def sentiment_analysis():
        ...
        print(
            "Tokenizing, removing stop words, lemmatizing and stemming positive words..."
        )
        ...
        # Blocco del codice
        find_features = lambda document: {
            w: (w in word_tokenize(document)) for w in word_features
        }  # lambda function to find features
